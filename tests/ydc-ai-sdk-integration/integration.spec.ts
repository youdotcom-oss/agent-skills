...
describe('YDC AI SDK Integration', () => {
  ...
  describe('Path A: generateText() with youSearch', () => {
    ...
    describe('happy path', () => {
      ...
      test('runtime: executes query with youSearch tool', async () => {
        expect(existsSync(generatedFile)).toBe(true);
      ...
      test('handles realistic web search query', async () => {
        expect(existsSync(generatedFile)).toBe(true);
        expect(process.env.YDC_API_KEY).toBeDefined();
        expect(process.env.ANTHROPIC_API_KEY).toBeDefined();
  ...
  describe('Path B: streamText() with youSearch and stopWhen', () => {
    ...
    describe('happy path', () => {
      ...
      test('runtime: streams text with tool calling', async () => {
        expect(existsSync(generatedFile)).toBe(true);
        expect(process.env.YDC_API_KEY).toBeDefined();
        expect(process.env.ANTHROPIC_API_KEY).toBeDefined();
      ...
      test('handles realistic streaming query', async () => {
        expect(existsSync(generatedFile)).toBe(true);
        expect(process.env.YDC_API_KEY).toBeDefined();
        expect(process.env.ANTHROPIC_API_KEY).toBeDefined();
        ...
        await module.main(
          ...
          (chunk: string) => { streamedText += chunk; }
        );
  ...
  describe('Path C: generateText() with Multiple Tools', () => {
    ...
    describe('happy path', () => {
      ...
      test('runtime: executes with multiple tools', async () => {
        expect(existsSync(generatedFile)).toBe(true);
        expect(process.env.YDC_API_KEY).toBeDefined();
        expect(process.env.ANTHROPIC_API_KEY).toBeDefined();
  ...
  describe('Path D: Custom API Key', () => {
    ...
    describe('happy path', () => {
      ...
      test('runtime: uses custom API key', async () => {
        expect(existsSync(generatedFile)).toBe(true);
