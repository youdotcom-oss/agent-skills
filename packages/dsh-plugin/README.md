...
| `knowledge` | `core` | off | Request licensed knowledge results alongside web and news, surfaced as the search result's answer `content` with data-provider credits appended. Only `core` is accepted. |
